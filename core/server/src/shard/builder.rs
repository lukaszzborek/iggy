...
pub struct IggyShardBuilder {
    ...
    is_follower: bool,
    shared_metadata: Option<Metadata>,
...
impl IggyShardBuilder {
    ...
    pub fn shared_metadata(mut self, shared_metadata: Metadata) -> Self {
    ...
    pub fn build(self) -> IggyShard {
        ...
        let shared_metadata = self.shared_metadata.expect("shared_metadata is required");
