...
pub mod sync_impl {
    ...
    impl ConsumerOffsetClient for ClientWrapper {
        fn store_consumer_offset(
            ...
            match self {
                ClientWrapper::Tcp(client) => client.store_consumer_offset(
                    consumer,
                    stream_id,
                    topic_id,
                    partition_id,
                ...
                ClientWrapper::TcpTls(client) => client.store_consumer_offset(
                    consumer,
                    stream_id,
                    topic_id,
                    partition_id,
        ...
        fn get_consumer_offset(
            ...
            match self {
                ClientWrapper::Tcp(client) => {
                    client.get_consumer_offset(consumer, stream_id, topic_id, partition_id)
                }
        ...
        fn delete_consumer_offset(
            ...
            match self {
                ClientWrapper::Tcp(client) => {
                    client.delete_consumer_offset(consumer, stream_id, topic_id, partition_id)
                }
                ClientWrapper::TcpTls(client) => {
                    client.delete_consumer_offset(consumer, stream_id, topic_id, partition_id)
                }
