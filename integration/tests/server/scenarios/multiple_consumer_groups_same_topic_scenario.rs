...
use crate::server::scenarios::{create_client, STREAM_ID, STREAM_NAME, TOPIC_ID, TOPIC_NAME};
...
async fn send_messages_and_poll_with_consumers(
    ...
    for i in 0..MESSAGES_COUNT {
        ...
        let message = Message::from_str(&message_payload).unwrap();
        system_client
            .send_messages(
                &Identifier::named(STREAM_NAME).unwrap(),
