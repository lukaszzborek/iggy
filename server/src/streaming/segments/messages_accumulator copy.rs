...
impl MessagesAccumulator {
    ...
    pub fn coalesce_batch(&mut self, current_offset: u64, mut batch: IggyMessagesMut) -> u32 {
        ...
        batch.prepare_for_persistence(self.base_offset, Some(self.current_timestamp));
